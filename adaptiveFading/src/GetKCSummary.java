...
public class GetKCSummary {
	...
	public static HashMap<String, Double> getItemKCEstimates(String usr, String grp) {
		...
		try {
			...
			JSONObject json = callService(bnServiceURL, usr, grp);
	...
	private static JSONObject callService(String url, String usr, String grp) {
		InputStream in = null;
